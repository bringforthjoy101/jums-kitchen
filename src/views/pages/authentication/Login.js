...
const ToastContentValid = ({ name, role }) => (
  <Fragment>
    ...
    <div className='toastify-body'>
      <span>You have successfully logged in as an {role} user to Real Obafunso Lounge. Now you can start to explore. Enjoy!</span>
    </div>
  </Fragment>
)
...
const ToastContentNotVerified = ({ name, role }) => (
  <Fragment>
    ...
    <div className='toastify-body'>
      <span>You have successfully logged in as an {role} user to Real Obafunso Lounge. Kindly change your password to continue. Thank you!</span>
    </div>
  </Fragment>
)
    ...
    <div className='auth-wrapper auth-v2'>
      <Row className='auth-inner m-0'>
        <Link className='brand-logo' to='/' onClick={e => e.preventDefault()}>
          ...
          <h2 className='brand-text text-primary ml-1'>Real Obafunso Lounge</h2>
        </Link>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            <CardTitle tag='h2' className='font-weight-bold mb-1'>
              Welcome to Real Obafunso Lounge 👋
            </CardTitle>
